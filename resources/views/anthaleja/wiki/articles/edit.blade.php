        ...
        <div class="card-body">
            <form action="{{ $formAction }}" method="POST">
                ...
                <div class="form-group">
                    <label for="auto_infobox">Genera Infobox automaticamente</label>
                    <input type="checkbox" name="auto_infobox" id="auto_infobox" value="1"
                        {{ old('auto_infobox', $article->auto_infobox) ? 'checked' : '' }}>
                </div>
